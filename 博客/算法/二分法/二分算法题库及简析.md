...
[P3853 [TJOI2007] 路标设置](https://www.luogu.com.cn/problem/P3853) **最大值最小化**
...
[P2678 [NOIP 2015 提高组] 跳石头](https://www.luogu.com.cn/problem/P2678) **最小值最大化** **双指针**
...
单调性: $f(连续和最大值) = 尽可能少的分段数 ↓$

**二分性质**: 

$f(连续和最大值) = 尽可能少的分段数 ≤ C$ 右分界点
